...
struct FormatSettings
{
    ...
    struct
    {
        ...
        /// proton: starts
        /// Iceberg field ids keyed by dotted field path (t.x, arr.element, m.key, m.value). Set by the
        /// Iceberg sink; honoured by the custom encoder only.
    ...
    struct
    {
        ...
        bool collapse_schema_registry_map_entry = true;
